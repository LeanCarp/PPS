<main class="listar-container" ng-init="obtenerCursadasAlumno(alumnoLog)">
          ...
          <table>
            ...
            <tbody>
              <tr ng-repeat="cursada in cursadas | orderBy:sortType:sortReverse | filter: buscar">
                ...
                <td>
                  <a title="Ver Examenes" href="#/alumno-examenes-listar/{{cursada.id}}"><i class="listar-iconos material-icons">find_in_page</i></a>
                  <a title="Ver archivos" href="#/alumno-archivo-listar/{{cursada.comision.idMateria}}"><i class="listar-iconos material-icons">archive</i></a>
