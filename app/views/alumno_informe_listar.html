<main class="listar-container" ng-init="obtenerInformes()">
    <a href="#/alumnos-listar" class="btn btn-volver">Volver</a>
    <a href="#/informes-agregar/{{idAlumno}}" class="btn btn-agregar">Agregar informe</a>
      ...
      <table>
        ...
        <tbody>
          <tr ng-repeat="informe in informes | orderBy:sortType:sortReverse | filter: buscar">
            ...
            <td>
                <a href="#/informes-ver/{{informe.id}}"><i title="Ver informe" class="listar-iconos material-icons">find_in_page</i></a>
