<main class="container">
    <a href="#/foro-temas/{{idCategoria}}" class="btn btn-agregar">Volver</a>

    <h2 ng-show="!isAdding">Agregar <strong>tema</strong></h2>
    <h2 ng-show="isAdding">Modificar <strong>tema</strong></h2>
    ...
    <div class="row">
        <form id="formTema" name="formTema" class="col s12" ng-submit="agregarTema(tema)">
            ...
            <input type="submit" class="btn" value="Modificar" ng-show="isAdding" ng-disabled="formTema.$invalid">
        </form>
    </div>
</main>
